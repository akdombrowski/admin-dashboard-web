...
export default function Authentication() {
    return (
      <>
        <div className="container relative hidden h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 bg-white text-black">
          <Link
